...
void check_repeated_cli_render(
    ...
    const std::filesystem::path output_a = output_path(root, label + "_a", extension);
    const std::filesystem::path output_b = output_path(root, label + "_b", extension);
...
void test_real_headless_reflection_cli(const std::filesystem::path& argv0) {
    ...
    const std::filesystem::path no_normals_obj = root / "no_normals.obj";
    ...
    const std::filesystem::path glossy_baseline = output_path(root, "glossy_baseline", "pfm");
    const std::filesystem::path glossy_reflection = output_path(root, "glossy_reflection", "pfm");
    check(
    ...
    const std::filesystem::path zero_baseline = output_path(root, "zero_baseline", "pfm");
    const std::filesystem::path zero_reflection = output_path(root, "zero_reflection", "pfm");
    check(
